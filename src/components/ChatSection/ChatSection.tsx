...
const ChatSection: React.FC = () => {
 ...
 const mainContainerClasses = useMemo(() => {
    return isChatActive
      ? 'bg-white h-[calc(100vh-3.5rem)] flex flex-row rounded-b-2xl lg:rounded-2xl lg:border lg:border-green-120 w-full lg:h-[80vh] overflow-hidden transition-all duration-300 shadow-xl relative'
